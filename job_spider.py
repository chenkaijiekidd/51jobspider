...
current_page = 1            #当前页数
req_url = 'https://search.51job.com/list/030200,000000,0000,00,9,99,python,2,{0}.html?lang=c&stype=&postchannel=0000&workyear=99&cotype=99&degreefrom=99&jobterm=99&companysize=99&providesalary=99&lonlat=0,0&radius=-1&ord_field=0&confirmdate=9&fromType=&dibiaoid=0&address=&line=&specialarea=00&from=&welfare='
...
def start_crawl():
    ...
    global current_page, total_page, req_url
